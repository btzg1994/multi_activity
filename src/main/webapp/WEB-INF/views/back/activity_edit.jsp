...
$(function(){
	...
	$('#saveBtn').click(function() {
		...
		$.ajax({
			type : 'post',
			url : "${pageContext.request.contextPath}/back/activity/editActivity",
			data : formData,
			cache : false,
			processData : false,
			contentType : false,
                ...
                <div class="formdiv">
                	<form id="editActivityForm" >
	                     ...
	                     <table  border="0" cellspacing="0" cellpadding="0" class="contab contab-wid">
	                          ...
	                          <c:if test="${!empty activity.img2}">
		                          <tr>
		                            <th>当前图片2：</th>
		                            <td ><img width="300px;" src="${pageContext.request.contextPath}/${activity.img2}"></td>
		                          </tr>
	                          </c:if>
	                          <c:if test="${empty activity.img2}">
		                          <tr>
	                          ...
	                          <tr>
	                            <th>图片2跳转链接：</th>
	                            <td><textarea id="img2Href" name="img2Href" rows="5" class="form-control myinput">${activity.img2Href}</textarea><font style="color:red;">（此项非必填，此项为空则不显示图片2）</font></td>
	                          </tr>
	                          <tr>
	                            <th>备注：</th>
